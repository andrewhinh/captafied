...
s3.meta.client.download_file(Bucket=write_bucket, Key=report_name, Filename=str(asset_path / report_name))
s3.meta.client.delete_object(Bucket=write_bucket, Key=report_name)
