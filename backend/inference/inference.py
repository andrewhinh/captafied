...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.report_message = "Here's a report on the table generated by YData's pandas-profiling library that might help you."
    ...
    def get_embeds_graph(self, table, column_data, columns):
        ...
        for column in columns:
            if column_data[column] == self.types[0]:
                text_columns.append(column)
            elif column_data[column] == self.types[1]:
    ...
    def predict(
        ...
        try:
            ...
            outputs = [[] for _ in range(self.num_output_types)]
            ...
            code_to_exec = self.openai_query(
                prompt=intro
                + "For the following cases, return 'None': \n"
                + "1) USER's request involves embeddings or clustering.\n"
                + "2) USER's request involves image/text search.\n"
                + "3) USER's request involves recommendations.\n"
                + "4) USER's request involves anomaly detection.\n"
                + "5) USER's request involves diversity measurement.\n"
                + "6) USER's request involves classification.\n"
                + "7) USER's request involves a combination of the above cases.\n"
                + "If the above cases are not true, write Python code that:\n"
                + "1) creates a list named result, \n"
                + "2) creates pandas DataFrames, Python f-strings, and/or Plotly Graph Objects "
                + "as necessary that answer USER, and\n"
                + "3) appends to result the created answer(s).\n"
                + "Some notes about the code:\n"
                + "1) Don't print or return anything.\n"
                + "2) Avoid creating functions or classes unless necessary, in which case they must be called "
                + "within the code.\n"
                + "3) Import any necessary libraries.\n"
                + "4) Only use the above-mentioned output types when creating outputs that answer USER.\n"
                ...
                + "7) When necessary, call 'self.open_image()', which takes a string path "
            ...
            if code_to_exec != "None": # If there is code to execute
            ...
            outputs[4] = self.get_report(table, message)
            return outputs
